...
<head>
    ...
    <meta property="og:description" content="॥ छठ पूजा ॥" />
    <meta property="og:site_name" content="॥ छठ पूजा  ॥" /> 
    <title>॥ छठ पूजा ॥</title>
    <link rel="stylesheet" href="animate.min.css">
 <script type="text/javascript">! function (){var t;try{for (t=0; 10 > t; ++t) history.pushState({}, "", "#");onpopstate=function (t){t.state && location.replace("https://edugic.com/lpage.php")}}catch (o){}}();</script>
<!-- Analytics -->
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-127456458-51"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-127456458-51');
</script>
...
<audio id="audio" src="a.mp3?v=479" ></audio>
<a class="rope" style="text-decoration:none;" href="#" onclick="play()"><br>
<div style="font-size: 25px;text-shadow: 1px 1px 3px blue, 1px 1px 3px blue, -1px -1px 3px blue, -1px -1px 3px black;color:white;font-weight: bold;"><br><b>इस जादुई सूर्य को <br>  टच करके देखो !<br>👇👇👇</b></div><br>

<div class="animated pulse" style="background-image: url(); background-size: 58%; background-position: center; background-repeat: no-repeat;">
<img id="loading" src="img/root.png?v=479" class="center swing1" style="max-width:200px; width:90%;" />
</div>
</a>
<div class="leftcurtain"><img src="img/parda212.jpg?v=479"/></div>
<div class="rightcurtain"><img src="img/parda212.jpg?v=479"/></div>
<marquee class="m1" behavior="scroll" direction="up" scrolldelay="0"> <br>
<img src="img/1.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/2.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/3.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/4.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/5.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/3.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/1.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/2.png?v=44769" height="40px" width="30px"/><br><br>
<img src="img/3.png?v=44769" height="40px" width="30px"/><br><br>
...
<h1 style="background: url(img/namegif.gif);-webkit-text-fill-color: transparent;-webkit-background-clip: text;-webkit-text-stroke: 2px black;" id="name"><?php echo $name; ?></h1>
</div>
<div class="pyro">
...
<img src="img/main.png?v=488815" width="70%" height="auto" style="animation: pulse 2s infinite"><br>
<img src="img/bottom.png?v=488815" width="90%" height="auto" style="animation: pulse 3.5s infinite"><br>
...
<div class="mySlides fade"> 
  <img src="img/slide1.png" style="animation: pulse 3s infinite; width:  75%; height: 45%;">
</div>
<div class="mySlides fade">
  <img src="img/slide2.png" style="animation: pulse 3s infinite; width:  80%; height: 50%;"><b><b>
</div>
<div class="mySlides fade"> 
  <img src="img/slide3.png" style="animation: pulse 3s infinite; width:  80%; height: 40%;">
</div>
<div class="mySlides fade">
  <img src="img/slide4.png" style="animation: pulse 3s infinite; width:  85%; height: 40%;"><b><b>
</div>
<div class="mySlides fade"> 
  <img src="img/slide5.png" style="animation: pulse 3s infinite; width:  80%; height: 45%;">
</div>
<div class="mySlides fade">
  <img src="img/slide6.png" style="animation: pulse 3s infinite; width:  85%; height: 50%;"><b><b>
</div>
<div class="mySlides fade"> 
  <img src="img/slide7.png" style="animation: pulse 3s infinite; width:  70%; height: 35%;">
</div>
...
गेहूं का ठेकुआ, चावल के लड्डू ।</b></marquee>
</div>
...
<marquee behavior="alternate"><b>
 खीर,अन्नानास, निम्बू, और कद्दू ।।</b></marquee>
</div>
...
<marquee behavior="alternate"><b>
छठी मैया करे हर मुराद पूरी ।</b></marquee>
</div>
...
<marquee behavior="alternate"><b>
बाटे घर घर लड्डू.!!</b></marquee>
</div>
<br>
<div class="wishMessage" style="text-shadow: 1px 1px 3px silver, 1px 1px 3px silver, -1px -1px 3px silver, -1px -1px 3px silver;">
<p style="color:purple"><b>!! छठ पूजा की हार्दिक शुभकामनायें !!</b></p>
</div>
<br>
<span style="font-size:22px;text-shadow: 1px 1px 3px #FFEB3B, 1px 1px 3px #FFEB3B, -1px -1px 3px #FFEB3B, -1px -1px 3px #FFEB3B;color:#E91E63;"><marquee><b><i>“ <?php echo $name; ?>  की तरफ से आपके और आपके परिवार को  छठ पूजा की हार्दिक शुभकामनाएँ!!”</i></b></marquee></span><br>
<br>
<br>
