...
<!-- Analytics -->
   ...
   <audio controls autoplay loop style="display:none">
      <source src="b.mp3?v=19685" type="audio/mpeg">
   </audio>
...
<br>
<span style="font-size:22px;text-shadow: 1px 1px 3px #FFEB3B, 1px 1px 3px #FFEB3B, -1px -1px 3px #FFEB3B, -1px -1px 3px #FFEB3B;color:#E91E63;"><marquee><b><i>“ <?php echo $name; ?>  की तरफ से आपको और आपके परिवार को  छठ पूजा की हार्दिक शुभकामनाएँ!!”</i></b></marquee></span><br>
<br>
<div class="glow"><?php echo $name; ?></div>
<br>
<br>

<a class="footerbtn" href="whatsapp://send?text=*<?php echo $name; ?>* ने आपको एक संदेश भेजा है, इस *नीली लाइन* को टच करो जादू देखो %0A 👇 👇%0A https://wish.hindisahayata.com/?n=<?php echo $name; ?>"><img width="25px" height="25px" src="img\whatsapp.png"><b style="font-size: 19px;">👉 यहाँ से सबको भेजें  👈</b>  <img width="25px" height="25px" src="img\whatsapp.png">
</a>
